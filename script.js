...
const translations = {
    es: {
        ...
        hero_role: "QA Analyst | System Analyst | Estudiante de Ingeniería",
        hero_desc: "Analista de Sistemas enfocado en asegurar la calidad y la integridad de datos en entornos críticos. Combino el testing técnico con conocimientos sólidos en <strong>C#, Python, .NET y SQL</strong> para optimizar procesos y prevenir fallas desde la arquitectura. Estudiante avanzado de Ingeniería en Sistemas (5to año).",
        hero_btn_projects: "Proyectos Técnicos",
        projects_titles: "Mis Proyectos",
        hero_btn_contact: "Charlemos",
        about_title: "Perfil Profesional <span class=\"text-primary\">.</span>",
        about_story_title: "Visión Técnica",
        about_story_text: "Como estudiante de 5to año de Ingeniería, mi diferencial es entender qué pasa 'detrás de escena'. No solo valido interfaces; analizo el comportamiento de las <strong>APIs</strong>, la consistencia en <strong>bases de datos SQL</strong> y la lógica de negocio en el código fuente.",
        about_exp_title: "Trayectoria Actual",
        about_exp_role_current: "QA Analyst @ Epidata (Sector Bancario)",
        about_exp_dates_current: "Jul 2025 - Actualidad",
        about_exp_desc_current: "Validación de flujos críticos (DEBIN, Transferencias). Monitoreo de integridad de datos en <strong>AS400</strong> y testing de microservicios con Postman/SoapUI.",
        about_exp_role_freelance: "QA Tester & Soporte Técnico",
        about_exp_dates_freelance: "Sep 2024 - Jul 2025",
        about_exp_desc_freelance: "Testing funcional web en <strong>evemtos.com.ar</strong>. Revisión de scripts en VS Code y soporte técnico nivel 2.",
        ...
        education_engineering_progress: "Restan 6 materias para finalizar",
    ...
    en: {
        ...
        hero_role: "QA Analyst | System Analyst | Engineering Student",
        hero_desc: "Systems Analyst focused on ensuring quality and data integrity in critical environments. I combine technical testing with solid knowledge in <strong>C#, Python, .NET, and SQL</strong> to optimize processes and prevent failures from the architecture level. Advanced Information Systems Engineering student (5th year).",
        hero_btn_projects: "Technical Projects",
        hero_btn_contact: "Let's Chat",
        about_title: "Professional Profile <span class=\"text-primary\">.</span>",
        about_story_title: "Technical Vision",
        about_story_text: "As a 5th-year engineering student, my differential is understanding what happens 'behind the scenes'. I don't just validate interfaces; I analyze the behavior of <strong>APIs</strong>, consistency in <strong>SQL databases</strong>, and business logic in source code.",
        projects_titles: "My Projects",
        about_exp_title: "Current Career Path",
        about_exp_role_current: "QA Analyst @ Epidata (Banking Sector)",
        about_exp_dates_current: "Jul 2025 - Present",
        about_exp_desc_current: "Validation of critical flows (DEBIN, Transfers). Data integrity monitoring in <strong>AS400</strong> and microservices testing with Postman/SoapUI.",
        about_exp_role_freelance: "QA Tester & Technical Support",
        about_exp_dates_freelance: "Sep 2024 - Jul 2025",
        about_exp_desc_freelance: "Web functional testing at <strong>evemtos.com.ar</strong>. Script review in VS Code and level 2 technical support.",
        ...
        education_engineering_progress: "6 subjects remaining to graduate",
